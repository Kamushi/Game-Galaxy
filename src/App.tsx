...
import mc5image from "./res/nintendo.png"
        ...
        <div className='buttonsCatalogo'>
         ...
         <div className='cardA'>
          ...
          <div className='card' style={{background: `url(${godImage})`, backgroundSize: `cover`}}>
           <MyButton bgColor='transparent' > 
            <h3>Playstation</h3></MyButton>
          </div>
          ...
          <div className='card' style={{background: `url(${mc5image})`, backgroundSize: `97% 97%`}}>
